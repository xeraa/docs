...
-	**Where to file issues**:  
	[https://jira.mariadb.org/](https://jira.mariadb.org/) under "MDEV" Project, and component "Packaging" or [GitHub](https://github.com/MariaDB/mariadb-docker/issues)
...
```console
$ docker run -p 127.0.0.1:3306:3306  --name some-mariadb -e MYSQL_ROOT_PASSWORD=my-secret-pw -d mips64le/mariadb:tag
```
...
$ docker run --net some-network --name some-mariadb -e MYSQL_ROOT_PASSWORD=my-secret-pw -d mips64le/mariadb:tag
```
